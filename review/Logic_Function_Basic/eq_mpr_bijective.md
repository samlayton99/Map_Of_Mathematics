...
Exact proof reference: record decl `d339` in `studies/Logic_Function_Basic.study.json` (type `x27615`, value `x27686`).

## P2 — support set (body)  [deterministic-derived]

**Domain (7):** `Eq`, `HEq`, `Function.Bijective`, `Function.Injective`, `Function.Surjective`, `eq_of_heq`, `HEq.refl`

**Classified infrastructure (9):** `Eq.casesOn` (generated), `Eq.mpr` (eq-machinery), `Eq.ndrec` (eq-machinery,generated), `Eq.refl` (eq-machinery), `And.intro` (logic-core,logic-core-ctor), `id` (eq-machinery), `Exists.intro` (logic-core,logic-core-ctor), `rfl` (eq-machinery), `Eq.symm` (eq-machinery)
