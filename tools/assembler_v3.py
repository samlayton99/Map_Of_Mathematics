...
def main():
    ...
    for tf, taskf in (("traces_neg300_ho.jsonl", "support_tasks_train300.json"),
                      ("traces_neg3k_ho.jsonl", "support_tasks_train3k.json")):
        try:
    ...
    test_decs, cov_te = decisions("traces_neg80_ho.jsonl", load_tasks("support_tasks_S1.json"))
    ...
    rank_eval(model.predict(Xte), yte, gte, mte, "LGBMRanker v3 (ho-probe traces)")
    ...
    import joblib
    joblib.dump(model, BIG / "assembler_v3.joblib")
    log("model saved")
