#!/usr/bin/env python3
"""Phase 4 certification, round 3 (seed 20260822; seeds 20260819/20/21 are
all development data and are excluded from the sample).
...
def main():
    ...
    with open(os.path.join(DATA, "phase4_holdout3_results.json"), "w") as f:
